const AboutUsSinglePersonCard = ({ name, description, gitHubLink, image }) => {
  return (
        ...
        <div className="flex flex-col">
          <div className="md:text-justify mb-3">
            <div className="flex flex-col mb-5">
              <p className="text-indigo-900 font-bold text-xl">{name}</p>

              <div className="mt-2 flex flex-row items-center justify-center md:justify-start ">
...
export default AboutUsSinglePersonCard;
